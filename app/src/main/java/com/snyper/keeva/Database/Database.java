package com.snyper.keeva.Database;
...
public class Database extends SQLiteAssetHelper {
    private  static final String DB_NAME="keevaDB.db";
    ...
    public void updateCart(Order order) {
        SQLiteDatabase db=getReadableDatabase();
        String query= String.format("UPDATE OrderDetail SET Quantity= '%s' WHERE  UserPhone='%s' AND ProductId='%s'",order.getQuality(),order.getUserPhone(),order.getProductId());
        db.execSQL(query);
    }
    ...
    public  void addToFavorites(Favorites food){
        ...
        String query= String.format("INSERT INTO " +
                "Favorites(FoodId,FoodName,FoodPrice,FoodMenuId,FoodImage,FoodDiscount,FoodDescription,UserPhone)" +
    ...
    public List<Favorites> getAllFavorites(String userPhone)
    {
        ...
        String[] sqlSelect={"FoodId","FoodName","FoodPrice","FoodMenuId","FoodImage",
