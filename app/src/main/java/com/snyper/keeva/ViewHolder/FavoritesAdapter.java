...
import com.snyper.keeva.FoodDetail;
import com.snyper.keeva.FoodList;
...
public class FavoritesAdapter extends RecyclerView.Adapter<FavoritesViewHolder> {
    ...
    public void onBindViewHolder(FavoritesViewHolder viewHolder, final int position) {
        ...
        viewHolder.food_price.setText(String.format("GH %s",favoritesList.get(position).getFoodPrice().toString()));
        ...
        viewHolder.setItemClickListener(new ItemClickListener() {
            ...
            public void onClick(View view, int position, boolean isLongClick) {
                ...
                foodDetail.putExtra("FoodId",favoritesList.get(position).getFoodId());//send foodid details to de next activity
